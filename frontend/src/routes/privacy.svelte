...
<script lang="ts">
	...
	let privacy = {
		...
		subheading: '1. Datenschutz auf einen Blick',
		smalheading: 'Allgemeine Hinweise',
		text1:
		...
		subheading2: '2. Allgemeine Hinweise und Pflichtinformationen',
		smalheading2: 'Datenschutz',
		text2:
		...
		text3: 'Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:',
		text4:
			'Verantwortliche Stelle ist die natürliche oder juristische Person, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten (z.B. Namen, E-Mail-Adressen o.Ä.) entscheidet.',
		smalheading3: 'Widerruf Ihrer Einwilligung zur Datenverarbeitung',
		text5:
		...
		smalheading4: 'SSL- bzw. TLS-Verschlüsselung',
		text6:
...
<Section>
	<Container>
		<Row>
			<Col>
				<div class="content">
					<h1 class="heading">{privacy.heading}</h1>
					<div class="divider" />
					<br />
					<h2 ref="general">{privacy.subheading}</h2>
					<h3>{privacy.smalheading}</h3>
					<p>{privacy.text1}</p>
					<h2>{privacy.subheading2}</h2>
					<h3>{privacy.smalheading2}</h3>
					<p>{privacy.text2}</p>
					<p>{privacy.text3}</p>
					...
					<p>{privacy.text4}</p>
					<h3>{privacy.smalheading3}</h3>
					<p>{privacy.text5}</p>
					<h3>{privacy.smalheading4}</h3>
